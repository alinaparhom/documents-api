(function() {
  ...
  async function requestAiBriefSummaryForFileDirect(source, apiUrl) {
    var sourceText = await requestOcrTextForSource(source, apiUrl);
    return requestAiBriefSummaryForText(source, sourceText, apiUrl, 'paid');
  }

  async function requestAiBriefSummaryByAttachment(source, apiUrl, aiMode) {
    var sourceText = await requestOcrTextForSource(source, apiUrl);
    return requestAiBriefSummaryForText(source, sourceText, apiUrl, aiMode);
  }
