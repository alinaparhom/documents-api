...
Помни: пользователь обратился к тебе за помощью. Сделай всё, чтобы ему было понятно и приятно.`
  ...
  function ensureVipAiModalStyles() {
    ...
    style.textContent += '.documents-vip-ai__composer{display:grid;gap:10px;padding:10px;background:linear-gradient(145deg,rgba(255,255,255,.88),rgba(248,250,252,.84));border:1px solid rgba(191,219,254,.55)}.documents-vip-ai__composer-main{display:grid;gap:8px}.documents-vip-ai__input{width:100%;min-height:90px;resize:vertical;border:1px solid rgba(191,219,254,.8);border-radius:14px;padding:12px 13px;background:rgba(255,255,255,.96);font-size:14px;line-height:1.48;color:#0f172a;box-shadow:inset 0 1px 2px rgba(15,23,42,.05)}.documents-vip-ai__input::placeholder{color:#94a3b8}.documents-vip-ai__input:focus{outline:none;box-shadow:0 0 0 3px rgba(56,189,248,.25),inset 0 1px 2px rgba(15,23,42,.04);border-color:rgba(56,189,248,.7)}.documents-vip-ai__composer-actions{display:flex;gap:8px;align-items:center;justify-content:space-between;flex-wrap:wrap}.documents-vip-ai__composer-tools{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center}.documents-vip-ai__voice-status{font-size:12px;color:#475569;padding:6px 10px;border-radius:999px;background:rgba(239,246,255,.85);border:1px solid rgba(191,219,254,.95)}.documents-vip-ai__action-btn{border:1px solid rgba(148,163,184,.35);background:linear-gradient(135deg,rgba(255,255,255,.98),rgba(248,250,252,.92));color:#0f172a;border-radius:12px;min-height:44px;padding:0 14px;font-size:13px;font-weight:700;box-shadow:0 8px 18px rgba(15,23,42,.08);transition:transform .16s ease,box-shadow .16s ease}.documents-vip-ai__action-btn:hover{transform:translateY(-1px);box-shadow:0 10px 22px rgba(15,23,42,.12)}.documents-vip-ai__action-btn--send{background:linear-gradient(135deg,#2563eb,#0ea5e9);color:#fff;border-color:rgba(37,99,235,.4)}.documents-vip-ai__action-btn--voice.is-active{background:linear-gradient(135deg,rgba(16,185,129,.22),rgba(45,212,191,.2));border-color:rgba(16,185,129,.55);color:#065f46}.documents-vip-ai__action-btn[disabled]{opacity:.55;cursor:not-allowed;box-shadow:none;transform:none}.documents-vip-ai__composer-actions-right{display:flex;gap:8px;align-items:center}@media (max-width:768px){.documents-vip-ai__composer{gap:8px;padding:8px}.documents-vip-ai__composer-tools{grid-template-columns:1fr}.documents-vip-ai__action-btn,.documents-vip-ai__template-btn{min-height:46px;font-size:14px}.documents-vip-ai__input{min-height:104px;font-size:15px}.documents-vip-ai__composer-actions{align-items:stretch;gap:7px}.documents-vip-ai__voice-status{width:100%;text-align:center}.documents-vip-ai__composer-actions-right{width:100%}.documents-vip-ai__composer-actions-right .documents-vip-ai__action-btn{flex:1}}';
