...
Помни: пользователь обратился к тебе за помощью. Сделай всё, чтобы ему было понятно и приятно.`
  ...
  function ensureVipAiModalStyles() {
    ...
    style.textContent += '.documents-vip-ai__composer{display:grid;grid-template-columns:1fr;gap:8px;padding:10px;background:linear-gradient(145deg,rgba(255,255,255,.88),rgba(248,250,252,.84));border:1px solid rgba(191,219,254,.55)}.documents-vip-ai__composer-main{display:grid;gap:8px;min-width:0}.documents-vip-ai__input{width:100%;max-width:100%;min-height:84px;resize:vertical;border:1px solid rgba(191,219,254,.8);border-radius:14px;padding:12px 13px;background:rgba(255,255,255,.96);font-size:14px;line-height:1.48;color:#0f172a;box-shadow:inset 0 1px 2px rgba(15,23,42,.05)}.documents-vip-ai__input::placeholder{color:#94a3b8}.documents-vip-ai__input:focus{outline:none;box-shadow:0 0 0 3px rgba(56,189,248,.25),inset 0 1px 2px rgba(15,23,42,.04);border-color:rgba(56,189,248,.7)}.documents-vip-ai__quickbar{display:grid;grid-template-columns:minmax(0,1fr) 48px 48px;gap:8px;align-items:center}.documents-vip-ai__quickbar .documents-vip-ai__select{width:100%;min-width:0}.documents-vip-ai__action-btn{border:1px solid rgba(148,163,184,.35);background:linear-gradient(135deg,rgba(255,255,255,.98),rgba(248,250,252,.92));color:#0f172a;border-radius:999px;min-height:48px;width:48px;padding:0;font-size:20px;font-weight:700;display:inline-flex;align-items:center;justify-content:center;box-shadow:0 8px 18px rgba(15,23,42,.08);transition:transform .16s ease,box-shadow .16s ease}.documents-vip-ai__action-btn:hover{transform:translateY(-1px);box-shadow:0 10px 22px rgba(15,23,42,.12)}.documents-vip-ai__action-btn--send{background:linear-gradient(135deg,#2563eb,#0ea5e9);color:#fff;border-color:rgba(37,99,235,.4)}.documents-vip-ai__action-btn--voice.is-active{background:linear-gradient(135deg,#ef4444,#f97316);border-color:rgba(239,68,68,.45);color:#fff}.documents-vip-ai__action-btn[disabled]{opacity:.55;cursor:not-allowed;box-shadow:none;transform:none}.documents-vip-ai__composer-meta{display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap}.documents-vip-ai__voice-status{font-size:12px;color:#475569;padding:6px 10px;border-radius:999px;background:rgba(239,246,255,.85);border:1px solid rgba(191,219,254,.95)}@media (max-width:768px){.documents-vip-ai__composer{gap:7px;padding:8px}.documents-vip-ai__quickbar{grid-template-columns:minmax(0,1fr) 46px 46px;gap:7px}.documents-vip-ai__action-btn{width:46px;min-height:46px}.documents-vip-ai__input{min-height:96px;font-size:15px}.documents-vip-ai__template-btn{min-height:42px}}';
  ...
  function openDocumentsVipAiPaidModal(config) {
    ...
    function updateVoiceStatus(text, isActive) {
      ...
      if (voiceButton) {
        ...
        voiceButton.textContent = isActive ? '⏺' : '🎤';
      }
