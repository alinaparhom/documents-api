(function () {
  ...
  var DEFAULT_AI_BEHAVIOR = 'Режим: деловой ответ сотрудника организации.\n'    + 'Отвечай по файлам, не пересказывай документы, а сразу давай итоговый текст ответа по задаче.\n'    + 'Пиши только готовый текст для вставки в шаблон: без приветствия, обращений, прощаний, подписи и реквизитов.';
