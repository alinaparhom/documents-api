...
function ensureAiDialogStyles() {
  ...
  style.textContent = `
    ...
    .appdosc-ai-dialog__panel{width:min(760px,100%);height:100dvh;max-height:100dvh;border-radius:22px 22px 0 0;background:linear-gradient(165deg,rgba(255,255,255,.92),rgba(255,255,255,.8));border:1px solid rgba(255,255,255,.7);box-shadow:0 18px 46px rgba(15,23,42,.22);display:flex;flex-direction:column;overflow:hidden;}
    ...
    .appdosc-ai-dialog__composer{padding:10px 12px calc(12px + env(safe-area-inset-bottom, 0px));border-top:1px solid rgba(148,163,184,.2);display:flex;flex-direction:column;gap:8px;background:rgba(255,255,255,.7);}
