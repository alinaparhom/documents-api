...
function getServerAiPromptsCatalog(): array
{
    ...
    $catalog = [
        ...
        'ASSISTANT_SCENARIO_DIRECTIVE' => [
            'brief_ai' => implode("\n", [
                'СЦЕНАРИЙ: «Краткий ИИ».',
                'Верни результат строго в формате из 3 блоков и только по фактам документа.',
                'Блок 1: «Кто прислал файл: ...».',
                'Блок 2: «Кому прислали файл: ...».',
                'Блок 3: «Суть файла: ...».',
                'Если данных нет — укажи «не указано в документе».',
                'Никаких дополнительных разделов, рекомендаций, итогов и воды.',
            ]),
            'response_ai' => implode("\n", [
...
function getBriefAiSystemPrompt(): string
{
    return "Ты — ИИ в режиме «Кратко ИИ».\n\n"
        ...
        . "1) Кто прислал файл: ...\n"
        . "2) Кому прислали файл: ...\n"
        . "3) Суть файла: ...\n\n"
        . "Ограничения:\n"
        . "- Только факты из переданного текста, без выдумок.\n"
        . "- Ровно 3 строки в указанном порядке, без списков и заголовков.\n"
        . "- Каждая строка — короткая фраза по делу.\n"
        . "- Не добавляй разделы «Рекомендации», «Итог», «Анализ».\n"
        . "- Если данных мало, пиши «не указано в документе» в соответствующей строке.\n";
}
...
function buildEffectiveUserPrompt(string $userPrompt, string $assistantMode): string
{
    ...
    if ($mode === 'brief_ai') {
        ...
        return $base . "\n\nВерни результат строго в формате:\n"
            ...
            . "Кому прислали файл: ...\n"
            . "Суть файла: ...\n"
            . "Только эти 3 строки, без дополнительных разделов.";
    }
...
function handleGenerateSummaryAction(array $env): void
{
    ...
    $requestPayload = [
        ...
        'messages' => [
            ...
            ['role' => 'user', 'content' => "Сделай «Кратко ИИ» строго в формате:\nКто прислал файл: ...\nКому прислали файл: ...\nСуть файла: ...\nЕсли поле не найдено — напиши «не указано в документе».\n\n" . $fullText],
        ],
    ];
