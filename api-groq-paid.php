...
if (!$hasReadableContent) {
    $limitedContextNotice = '⚠️ В файлах не удалось извлечь читаемый текст (возможен скан низкого качества). '
        . 'Сформируй нейтральный рабочий ответ только на основе запроса пользователя и метаданных файлов. '
        . 'Добавь коротко, какие данные нужны для более точного решения.';
}
