...
function getServerAiPromptsCatalog(): array
{
    ...
    $catalog = [
        ...
        'ASSISTANT_SCENARIO_DIRECTIVE' => [
            'brief_ai' => implode("\n", [
                'СЦЕНАРИЙ: «Краткий ИИ».',
                'Нужно определить: кто отправитель и кто получатель по содержимому документов.',
                'После получателя добавь краткое содержание файла (3-6 предложений).',
                'Ответ строго в формате: "Кто прислал : <кто прислал>, Кому прислали: <кому прислали>, Краткое содержание: <3-6 предложений>".',
                'Если отправитель или получатель не найден(ы), укажи "не найдено".',
                'Никаких дополнительных пояснений, списков, markdown и лишнего текста.',
            ]),
            'response_ai' => implode("\n", [
